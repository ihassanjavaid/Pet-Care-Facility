...
<div class = "box">
        <table>
            ...
            $sql = "Select distinct `First Name`, `Last Name`, Address, `Phone Number`, Email, `Hire Date`, `Working Hours`, Education, Qualification from (Select * from mydb.user inner join mydb.employee using (CNIC)) T1 left outer join mydb.`enrolled case` using (`Employee ID`) where `Employee ID` = $id";
...
<div class = "box3">
        <li><a href="UpdateEmployeeRecord.php">Update</a></li>
        <li><a href = "php/DeleteEmployee.php" >Delete</a></a></li>
